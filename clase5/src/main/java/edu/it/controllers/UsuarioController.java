...
import edu.it.error.MeTrabeConLareserva;
...
public class UsuarioController {
    ...
    public Object busquedaPorParams(
        ...
        if (nombre.equals("hacerReserva")) {
            // Paso1 -> Paso2 -> Paso3 -> ConcretarReserva
            throw new MeTrabeConLareserva();
        }

        if (nombre.equals("noVino")) {
            throw new edu.it.error.NoVinoNombreException();
        }
